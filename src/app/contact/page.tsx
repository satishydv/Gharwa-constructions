...
const ContactPage = () => {
  ...
  return (
    <div className="pt-32 pb-9 min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto items-start">
          ...
          <div className="bg-gray-200 dark:bg-gray-700 p-6 rounded-lg h-fit">
